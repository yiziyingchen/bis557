...
With absolute deviation loss function derivative, we have see the size of weights decrease as the penalty term increases. Compared with using mse (6.942948e+00, 1.674410e+00, 3.672386e-02, 7.117368e-07), the decrease in weights is smaller using absolute deviation loss function.
